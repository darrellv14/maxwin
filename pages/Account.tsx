...
const Account: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-terminal-black text-gray-200">
      {/* Header */}
      <header className="border-b border-gray-800 bg-terminal-dark/50 backdrop-blur sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-3 sm:px-4 py-2 sm:py-3 flex justify-between items-center">
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              to="/"
              className="text-xs sm:text-sm font-mono bg-gray-900 px-3 py-1 rounded-full border border-gray-800 hover:bg-gray-800 text-gray-300 flex items-center gap-2"
            >
              ← Dashboard
            </Link>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gray-800 rounded-full flex items-center justify-center border border-gray-700">
                <User className="w-4 h-4 text-profit-green" />
              </div>
              <div className="hidden sm:block">
                <p className="text-xs text-gray-400 font-mono uppercase">Logged in as</p>
                <p className="text-xs font-mono text-white">{user?.name || "User"}</p>
              </div>
            </div>
          </div>
        </div>
